...
import dj_database_url # it was imported
...
INSTALLED_APPS = [
    ...
    'django_filters', # Add this (note the underscore)
    'notes',
]
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_max_age=600,
        ssl_require=True  # set to False if running locally without SSL
    )
}
...
# Add this at the bottom of settings.py to tell DRF to look for Tokens
REST_FRAMEWORK = {
